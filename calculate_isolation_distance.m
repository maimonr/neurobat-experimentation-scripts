function IsolDist = calculate_isolation_distance(Fet, ClusterSpikes, m)
...
% copied from https://github.com/vandermeerlab/vandermeerlab/blob/master/code-matlab/toolboxes/MClust-3.5/ClusterQuality/IsolationDistance.m
if nargin < 3
	nSpikes = size(Fet,1);
else
	nSpikes = size(m,1);
